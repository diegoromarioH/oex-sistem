  ...
  return (
    <div>
      ...
      <div className="grid-4 mt-16">
        <div className="metric"><b>Ingresos</b><span className="metric-value" style={{ color: "var(--success)" }}>${datosActual.ingresos.toFixed(2)}</span><Delta actual={datosActual.ingresos} anterior={datosAnterior.ingresos} /></div>
        <div className="metric"><b>Costos</b><span className="metric-value">${datosActual.costos.toFixed(2)}</span><Delta actual={datosActual.costos} anterior={datosAnterior.costos} invertirColor /></div>
        <div className="metric"><b>Gastos</b><span className="metric-value">${datosActual.gastos.toFixed(2)}</span><Delta actual={datosActual.gastos} anterior={datosAnterior.gastos} invertirColor /></div>
        <div className="metric"><b>Utilidad neta</b><span className="metric-value" style={{ color: datosActual.utilidad >= 0 ? "var(--success)" : "var(--danger)" }}>${datosActual.utilidad.toFixed(2)}</span><Delta actual={datosActual.utilidad} anterior={datosAnterior.utilidad} /></div>
      </div>
